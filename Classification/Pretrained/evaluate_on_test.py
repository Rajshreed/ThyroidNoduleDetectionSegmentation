...
testdata_path = "../../data/TNSCUI2020_train/classification_ds/resized_test/no/"

base_model = applications.vgg16.VGG16(weights= 'imagenet', include_top=False, input_shape= (img_height,img_width,3)) # None
...
model.load_weights("./models/vgg16_918-0.87.h5")
