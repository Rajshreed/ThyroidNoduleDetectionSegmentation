'''
Description:
	Predict python script for Unet model given the ultrasound image and a dot from the user
'''

from glob import glob
import numpy as np
import cv2
from medo_api.models.networks.Unet_0 import get_unet0
from medo_api.io.data_loaders import Generator_Thyroid_clickpt_roi_segmentation
...
# Define the path where the test set is located  
#image_ROIs_path = '/data/Thyroid_2D_Set2_ROIs/
image_path =  './testing_comp_img/'
image_masks_path =  './testing_comp_msk/'
...
weights_path = './models/weights_thyroid_dot_512_balanced_aug_task19_v1.h5' #weights_thyroid_dot_512_extra_UNET_layer_task18_v1.h5'
# weights_thyroid_dot_512_aug_expmask_task13_v1.h5'#weights_thyroid_dot_512_junk_aug_task11_v2.h5' #weights_thyroid_dot_512_upsample_traindata_task11_v1.h5' # weights_thyroid_dot_512_more_traindata_task10_v1.h5' #weights_thyroid_dot_512_unet_64_task9_v1_93acc_E3.h5'#weights_thyroid_dot_512_task8_v1.h5'#'./models/weights_thyroid_dot_alldata_task6_v1.h5'#_98acc_E14.h5' weights_thyroid_dot_512_task8_v1_93acc_4E.h5
...
#	cv2.waitKey(5000)
	...
	show[:,:,2] = prediction1
	path_='./data/test/results_aug_bal/' + jpg_name
